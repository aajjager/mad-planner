...
Before exposing Mad Planner beyond localhost, follow the [HTTPS setup guide](docs/https-setup.md). It includes the optional Cloudflare Tunnel Compose deployment as well as Caddy and TrueNAS guidance. HTTPS is required for secure production cookies, passkeys, and reliable phone notifications.
