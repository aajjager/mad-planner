...
Before exposing Mad Planner beyond localhost, follow the [HTTPS setup guide](docs/https-setup.md). HTTPS is required for secure production cookies, passkeys, and reliable phone notifications.
