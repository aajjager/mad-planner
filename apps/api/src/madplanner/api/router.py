...
from madplanner.api.routes.auth import router as auth_router
...
from madplanner.api.routes.recipe_scans import router as recipe_scans_router
...
api_router.include_router(recipe_scans_router)
