...
def preview_recipe(data: RecipeImportRequest, importer: Annotated[RecipeImporter, Depends(get_recipe_importer)], _context: Annotated[AuthContext, Depends(require_auth)]):
    try:
