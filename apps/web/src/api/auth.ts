...
export const submitFeedback = (content: string, category: FeedbackCategory) => request<Feedback>('/api/v1/auth/feedback', jsonOptions('POST', { content, category }))
...
export const completeApprovedFeedback = (category: FeedbackCategory) => request<{ completed: number }>('/api/v1/auth/admin/feedback/complete-approved', jsonOptions('POST', { category }))
