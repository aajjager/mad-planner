...
const categoryLabels: Record<string, Record<string, string>> = {
  da: { Produce: 'Frugt og grønt', 'Meat & fish': 'Kød og fisk', 'Dairy & eggs': 'Mejeri og æg', Bakery: 'Brød og bagværk', Pantry: 'Kolonialvarer', Frozen: 'Frostvarer', Household: 'Husholdning', Other: 'Andet' },
  nl: { Produce: 'Groente en fruit', 'Meat & fish': 'Vlees en vis', 'Dairy & eggs': 'Zuivel en eieren', Bakery: 'Brood en bakkerij', Pantry: 'Voorraadkast', Frozen: 'Diepvries', Household: 'Huishouden', Other: 'Overig' },
}
const categoryLabel = (category: string, locale: string) => categoryLabels[locale.slice(0, 2)]?.[category] || category
