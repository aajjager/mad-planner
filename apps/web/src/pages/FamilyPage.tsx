...
export function FamilyPage() {
  ...
  return <section className="page family-page">
    ...
    <Link className="family-panel updates-settings-link" to="/updates"><span><strong>{t('whatsNew')}</strong><small>{t('updatesIntro')}</small></span><b aria-hidden="true">v0.2.3 →</b></Link>
    <MfaSettings />
