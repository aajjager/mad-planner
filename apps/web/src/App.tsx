    ...
    <BrowserRouter>
      <div className="app-shell">
        <header className="site-header">
          ...
          <nav aria-label="Main navigation"><Link to="/recipes">Recipes</Link><Link to="/recipes/import">Import</Link><Link className="primary-link" to="/recipes/new">Add recipe</Link></nav>
          <HealthIndicator />
        </header>
        <main>
          <Routes>
